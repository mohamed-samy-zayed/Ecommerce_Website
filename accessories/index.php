...
<html lang="en">
    ...
    <body>
        ...
        <!-- Breadcrumb End -->
        <!-- Shop Start -->
        <div id="loadingProductsIndicator" style="display: none; text-align:center">
            Loading Products...
        </div>
        <div class="container-fluid">
            <div class="row px-xl-5">
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <a class="h6 text-decoration-none text-truncate" href="men/index.php">Men</a>
                    </div>
                    <div class="bg-light p-4 mb-30">
                    <i class="fa fa-angle-right mr-2"></i>
                    <a class="h6 text-decoration-none text-truncate" href="women/index.php">Women</a>
                    </div>
                    <div class="bg-light p-4 mb-30">
                    <i class="fa fa-angle-right mr-2"></i>
                    <a class="h6 text-decoration-none text-truncate" href="child/index.php">Children</a>
                    </div>
                    <!-- Price End -->
                </div>
                <!-- Shop Sidebar End -->
                            ...
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    ...
                                    <div class="product-action">
                                        <a class="btn btn-outline-dark btn-square" href="men/index.php">
                                            View
                                        </a>
                                ...
                                <div class="text-center py-4">
                                    <a class="h6 text-decoration-none text-truncate" href="men/index.php">Men Accessories</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="../img/women.jpg" alt="">
                                    <div class="product-action">
                                        <a class="btn btn-outline-dark btn-square" href="women/index.php">
                                            View
                                        </a>
                                ...
                                <div class="text-center py-4">
                                    <a class="h6 text-decoration-none text-truncate" href="women/index.php">Women Accessories</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="../img/child.jpg" alt="">
                                    <div class="product-action">
                                        <a class="btn btn-outline-dark btn-square" href="child/index.php">
                                            View
                                        </a>
                                ...
                                <div class="text-center py-4">
                                    <a class="h6 text-decoration-none text-truncate" href="child/index.php">Children Accessories</a>
                                </div>
                            </div>
                        </div>
