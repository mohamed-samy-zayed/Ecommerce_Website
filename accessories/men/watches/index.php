                ...
                <div class="col-lg-9 col-md-8" >
                    <div class="row pb-3" id=productsContainer>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="../../../img/accessories/men/watches/classic/15/1.jpg" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="../../../img/accessories/men/watches/casual/2/1.jpg" alt="">
                                    <div class="product-action">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="../../../img/accessories/men/watches/sport/11/1.jpg" alt="">
                                    <div class="product-action">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="../../../img/accessories/men/watches/premium/2/1.jpg" alt="">
                                    <div class="product-action">
