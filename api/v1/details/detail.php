...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <script>
                                    ...
                                    function singup() {
                                        // Redirect to the specified URL
                                        window.location.href = "http://localhost/all/project/ecommerce/signupF.php";
                                    }
                                    function logout() {
                                        // Redirect to the specified URL
                        ...
                        <div class="navbar-nav w-100">
                            <div class="nav-item dropdown dropright">
                                ...
                                <div class="dropdown-menu position-absolute rounded-0 border-0 m-0">
                                    <a href="men/men.php" class="dropdown-item">Men's Dresses</a>
                                    <a href="women/women.php" class="dropdown-item">Women's Dresses</a>
                                    <a href="child/child.php" class="dropdown-item">Baby's Dresses</a>
                                </div>
                            </div>
            ...
            <div class="row px-xl-5">
                <div class="col-lg-5 mb-30">
                    <div id="product-carousel" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner bg-light">
                            <div class="carousel-item active" id="img_container" style="width: 300px; height:300px; margin-left: 90px;">
                ...
                <div class="col-lg-7 h-auto mb-30">
                    <div class="h-100 bg-light p-30">
                        ...
                        <form method="POST" action="orders/order.php">
                            <div class="d-flex mb-3">
                            ...
                            <div>
                                <label style="font-size: medium; font-weight:bold; color:black;" for="username"><span style="color: red; font-size:x-large;">*</span> Your Full Name:</label>
                                <br>
                                <input type="text" id="username" name="username"  placeholder="Enter Name" required style="width:300px;">
                            </div>
                            <br>
                            <div>
                                <label style="font-size: medium; font-weight:bold; color:black;" for="phoneNumber"><span style="color: red; font-size:x-large;">*</span> Phone Number:</label>
                                <br>
                                <input type="tel" id="phoneNumber" name="phoneNumber"  placeholder="Enter phone number" required style="width:300px;">
                            </div>
                            <br>
                            <div>
                                <label style="font-size: medium; font-weight:bold; color:black;" for="location"><span style="color: red; font-size:x-large;">*</span> Please provide the location where you would like to receive the product:</label>
                                <!-- <textarea name="loc" id="location" cols="30" rows="4" require placeholder="Write Your Address Here"></textarea> -->
                                <input type="text" id="location" name="loc" placeholder="Enter your location" required style="width:300px;"  >
                            </div>
                            <br>
                            <div class="d-flex align-items-center mb-4 pt-2">
                                <div class="input-group quantity mr-3" style="width: 130px;">
                                    <div class="input-group-btn">
                                        <button type="button" class="btn btn-primary btn-minus" onclick="decrementCount()">
                                            <i class="fa fa-minus"></i>
                                        </button>
                                    </div>
                                    <input type="text" class="form-control bg-secondary border-0 text-center" value="0" name="count" id="quantityInput">
                                    <div class="input-group-btn">
                                        <button type="button" class="btn btn-primary btn-plus" onclick="incrementCount()">
        ...
        <script src="js/detailFetchProduct.js"></script>
        <script src="js/profile_img.js"></script>
        <script src="js/detail_product_counter.js"></script>
    </body>
</html>
<?php
}
...
{
    header("Location: loginF.php?error=Please+Login+First");
}
?>