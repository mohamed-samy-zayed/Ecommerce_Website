...
<html lang="en">
    <head>
        ...
        #loadingFilteredProductsIndicator, #filter_error, #api_error {
            display: none;
            text-align: center;
            margin-top: 15px;
        }
        #loadingFilteredProductsIndicator {
            color: blue;
        }
        #filter_error {
            color: green;
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="balance.php" class="nav-item nav-link active">Balance</a>
                            </div>
            ...
            <div class="row px-xl-5">
                <div class="col-12">
                    <nav class="breadcrumb bg-light mb-30">
                        ...
                        <a class="breadcrumb-item text-dark" href="shop.php">Account</a>
        ...
        <div class="container-fluid">
            <div class="row px-xl-5">
                ...
                <div class="col-lg-9 col-md-8">
                    ...
                    <!-- Balance Form Srarts -->
                    <!-- <div class="container" >
                        <h2 style="text-align: center;">Add Balance</h2>
                        <br>
                        <form action="balanceAPI.php" method="POST">
                            <div class="form-group">
                                <label for="amount">Amount to Add:</label>
                                <input class="form-control" type="number" id="amount" name="amount" required min="1" step="1" placeholder="Balance Amount">
                            </div>
                            <div class="form-group">
                                <div class="input-group-append">
                        ...
                        <div id="filter_error" style="display: none; text-align:center; color:green;">  
                            <strong>Successful Process</strong>    
                        </div>
                    ...
                    <!-- Balance Form Ends -->
                    <!-- Chat GPT4 Balance Form Starts -->
                    <div class="container">
                    <h2 style="text-align: center;">Add Balance</h2>
                    <p style="text-align: center;">Current Balance: <span id="currentBalance">0</span></p>
                    <br>
                    <form id="balanceForm">
                        <br>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="input-group-append">
                                <button type="button" class="btn btn-primary" onclick="submitForm()">Add Balance</button>
                            </div>
                        </div>
                    </form>
                    <div id="loadingFilteredProductsIndicator">
                        <strong>Loading...</strong>
                    </div>
                    <div id="filter_error">
                        <strong>Successful Process</strong>
    ...
    <script src="js/account/balance.js"></script>
