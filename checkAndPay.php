...
<html lang="en">
        ...
        <div class="container-fluid">
            <div class="row px-xl-5">
                ...
                <div class="col-lg-9 col-md-8">
                    <div style="color: black; " id=""><h4>Check Your Products</h4></div>
                    <br>
                    <div class="row pb-3" id="ProductContainer">
                        <div class="col-12 pb-1">
                            ...
                            <div id="loadingProductsPriceIndicatorAfterRemoving" style="display: none; text-align:center; color:blue;">
                                <strong>Loading Price...</strong>    
                            </div>
                            <div style="display: flex;" id="products_price">
                                <div id="loadingProductsPriceIndicator" style="display: none; text-align:center; color:blue;">
                                    <strong>Loading Price...</strong>    
                                </div>
                            </div>
                            <div style="display: flex;" id="deliver_price"></div>
                            <div style="display: flex;" id="total_price"></div>
                        </div>
                    ...
                    <div>
                        ...
                        <button type="submit" class="btn btn-primary px-3" onclick="PaymentCredit()">
                            <!-- <i class="fab fa-cc-visa"></i> -->
                            <!-- <i class="fas fa-money-bill"></i> -->
                            <!-- <i class="fas fa-handshake"></i> -->
                            <i class="far fa-credit-card"></i>
                            <strong>With Credit Card</strong>
                        </button>
                    </div>
                    <br>
                    <div>
                        <button type="submit" class="btn btn-primary px-3" onclick="PaymentOnDelivery()">
                            <!-- <i class="fas fa-dollar-sign"></i>
                            <i class="fas fa-handshake"></i>
                            <i class="fas fa-truck"></i>
                            <i class="fas fa-hand-holding-usd"></i> <i class="fas fa-truck"></i> -->
                            <i class="fas fa-money-bill"></i>
    ...
    <script src="js/Cart/fetchProduct.js"></script>
