        ...
        <div class="container-fluid">
            <div class="row px-xl-5">
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <a class="h6 text-decoration-none text-truncate" href="childJackets.php">Jackets</a>
                    </div>
                    <div class="bg-light p-4 mb-30">
                    <i class="fa fa-angle-right mr-2"></i>
                    <a class="h6 text-decoration-none text-truncate" href="child_T_Shirts.php">T-Shirts</a>
                    </div>
                    <div class="bg-light p-4 mb-30">
                    <i class="fa fa-angle-right mr-2"></i>
                    <a class="h6 text-decoration-none text-truncate" href="childShirts.php">Shirts</a>
                    </div>
                    <div class="bg-light p-4 mb-30">
                    <i class="fa fa-angle-right mr-2"></i>
                    <a class="h6 text-decoration-none text-truncate" href="childPants.php">Pants</a>
                    </div>
                    <div class="bg-light p-4 mb-30">
                    <i class="fa fa-angle-right mr-2"></i>
                    <a class="h6 text-decoration-none text-truncate" href="childShoes.php">Shoes</a>
                    </div>
                    <!-- Price End -->
                </div>
                <!-- Shop Sidebar End -->
                <div class="col-lg-9 col-md-8" >
                    <div class="row pb-3" id=productsContainer>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="../../img/clothes/child/t_shirts/1/1.jpg" alt="">
                                    <div class="product-action">
                                        <a class="btn btn-outline-dark btn-square" href="child_T_Shirts.php">
                                            View
                                        </a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="../../img/clothes/child/jackets/1/1.jpg" alt="">
                                    <div class="product-action">
                                        <a class="btn btn-outline-dark btn-square" href="childJackets.php">
                                            View
                                        </a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="../../img/clothes/child/pants/1/1.jpg" alt="">
                                    <div class="product-action">
                                        <a class="btn btn-outline-dark btn-square" href="childPants.php">
                                            View
                                        </a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="../../img/clothes/child/shirts/1/1.jpg" alt="">
                                    <div class="product-action">
                                        <a class="btn btn-outline-dark btn-square" href="childShirts.php">
                                            View
                                        </a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="../../img/clothes/child/shoes/1/1.jpg" alt="">
                                    <div class="product-action">
                                        <a class="btn btn-outline-dark btn-square" href="childshoes.php">
                                            View
                                        </a>
