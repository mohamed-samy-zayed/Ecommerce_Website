            ...
            <div class="row px-xl-5">
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    <h5 class="section-title position-relative text-uppercase mb-3">
                        <span class="bg-secondary pr-3">Furniture Categories</span>
                    </h5>
                    <div class="bg-light p-4 mb-30">
                    <i class="fa fa-angle-right mr-2"></i>
                    <a class="h6 text-decoration-none text-truncate" href="chairs/index.php">Chairs</a>
                    </div>
                    <div class="bg-light p-4 mb-30">
                    <i class="fa fa-angle-right mr-2"></i>
                    <a class="h6 text-decoration-none text-truncate" href="tables/index.php">Tables</a>
                    </div>
                    <div class="bg-light p-4 mb-30">
                    <i class="fa fa-angle-right mr-2"></i>
                    <a class="h6 text-decoration-none text-truncate" href="fan/index.php">Fan</a>
                    </div>
                    <div class="bg-light p-4 mb-30">
                    <i class="fa fa-angle-right mr-2"></i>
                    <a class="h6 text-decoration-none text-truncate" href="watches/index.php">Alarm Watches</a>
                    </div>
                    <div class="bg-light p-4 mb-30">
                    <i class="fa fa-angle-right mr-2"></i>
                    <a class="h6 text-decoration-none text-truncate" href="spotlight/index.php">Spotlights</a>
                    </div>
                    <div class="bg-light p-4 mb-30">
                    <i class="fa fa-angle-right mr-2"></i>
                    <a class="h6 text-decoration-none text-truncate" href="carpetes/index.php">Carpets</a>
                    </div>
                    <div class="bg-light p-4 mb-30">
                    <i class="fa fa-angle-right mr-2"></i>
                    <a class="h6 text-decoration-none text-truncate" href="electric/index.php">Electric Things</a>
                    </div>
                    <!-- Price End -->
                </div>
                <!-- Shop Sidebar End -->
                <div class="col-lg-9 col-md-8" >
                    <div class="row pb-3" id=productsContainer>
                            ...
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    ...
                                    <div class="product-action">
                                        <a class="btn btn-outline-dark btn-square" href="chairs/index.php">
                                            View
                                        </a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="../img/furniture/tables/1/1.jpg" alt="">
                                    <div class="product-action">
                                        <a class="btn btn-outline-dark btn-square" href="tables/index.php">
                                            View
                                        </a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    ...
                                    <div class="product-action">
                                        <a class="btn btn-outline-dark btn-square" href="fan/index.php">
                                            View
                                        </a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    ...
                                    <div class="product-action">
                                        <a class="btn btn-outline-dark btn-square" href="spotlight/index.php">
                                            View
                                        </a>
                                ...
                                <div class="text-center py-4">
                                    <a class="h6 text-decoration-none text-truncate" href="spotlight/index.php">Spotlight</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    ...
                                    <div class="product-action">
                                        <a class="btn btn-outline-dark btn-square" href="carpets/index.php">
                                            View
                                        </a>
                                ...
                                <div class="text-center py-4">
                                    <a class="h6 text-decoration-none text-truncate" href="carpets/index.php">Carpets</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 pb-1">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="../img/furniture/electric/1/1.jpg" alt="">
                                    <div class="product-action">
                                        <a class="btn btn-outline-dark btn-square" href="electric/index.php">
                                            View
                                        </a>
