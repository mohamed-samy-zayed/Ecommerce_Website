...
.then(data => {
    ...
    var imgContainer = document.getElementById('img_container');
        ...
        <div class="zoom-container">
            <img src="${data.img_url}" alt="Image" id="product_img" class="img-fluid w-100 zoom-image">
        </div>
            `;
    /* Delete Size Choose Form IF Not Neccessary */
    var imgUrl = `${data.img_url}`;
    if (imgUrl.includes('computers') || imgUrl.includes('furniture') || imgUrl.includes('accessories') ) {
