...
setTimeout(function () {
// Get All Products
    fetch('http://localhost/all/project/ecommerce/api/v1/clothes/child/childAPI.php')
      ...
      // Log or store the selected price range
        ...
        elementsToRemove.forEach(element => {
            ...
            setTimeout(function () {
                ...
                var url = `http://localhost/all/project/ecommerce/api/v1/clothes/child/childAPI.php?filter=${filter}`;
                fetch(url)
                .then(response => response.json())
                .then(data => {
                    // Hide loading indicator for filtered products
