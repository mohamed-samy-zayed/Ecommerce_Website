...
setTimeout(function () {
    // Show All Products 
    fetch('http://localhost/all/project/ecommerce/api/v1/clothes/child/pantsAPI.php')
      ...
      // Log or store the selected price range
        ...
        elementsToRemove.forEach(element => {
            ...
            setTimeout(function () {
                ...
                var url = `http://localhost/all/project/ecommerce/api/v1/clothes/child/pantsAPI.php?filter=${filter}`;
                fetch(url)
                .then(response => response.json())
                .then(data => {
                    // Update the frontend with the product data
