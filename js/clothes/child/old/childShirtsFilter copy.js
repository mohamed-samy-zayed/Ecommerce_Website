...
setTimeout(function () {
    // Show All Products 
    fetch('http://localhost/all/project/ecommerce/api/v1/clothes/child/shirtsAPI.php')
        ...
        elementsToRemove.forEach(element => {
            element.remove();
                ...
                setTimeout(function () {
                    ...
                    var url = `http://localhost/all/project/ecommerce/api/v1/clothes/child/shirtsAPI.php?filter=${filter}`;
                    fetch(url)
                    .then(response => response.json())
                    .then(data => {
                        // Update the frontend with the product data
