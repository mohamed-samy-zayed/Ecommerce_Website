...
setTimeout(function () {
    // Get all Products
    fetch('http://localhost/all/project/ecommerce/api/v1/clothes/child/shoesAPI.php')
        ...
        elementsToRemove.forEach(element => {
            element.remove();
                ...
                setTimeout(function () {
                    ...
                    var url = `http://localhost/all/project/ecommerce/api/v1/clothes/child/shoesAPI.php?filter=${filter}`;
                    fetch(url)
                    .then(response => response.json())
                    .then(data => {
                        // Update the frontend with the product data
