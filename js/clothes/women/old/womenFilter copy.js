// Get All Products
fetch('http://localhost/all/project/ecommerce/api/v1/clothes/women/womenAPI.php')
                ...
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            ...
                            <a class="btn btn-outline-dark btn-square" href="../../detail.php?id=${product.id}&category=${product.category}_w&kind=${product.kind}">
...
checkboxes.forEach((checkbox) => {
    ...
    if (checkbox.checked) {
      ...
      // Log or store the selected price range
        ...
        var url = `http://localhost/all/project/ecommerce/api/v1/clothes/women/womenAPI.php?filter=${filter}`;
        fetch(url)
        .then(response => response.json())
        .then(data => {
            // Update the frontend with the product data
