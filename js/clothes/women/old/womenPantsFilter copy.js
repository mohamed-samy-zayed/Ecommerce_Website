// Show All Products 
fetch('http://localhost/all/project/ecommerce/api/v1/clothes/women/pantsAPI.php')
...
checkboxes.forEach((checkbox) => {
    ...
    if (checkbox.checked) {
      ...
      // Log or store the selected price range
        ...
        var url = `http://localhost/all/project/ecommerce/api/v1/clothes/women/pantsAPI.php?filter=${filter}`;
        fetch(url)
        .then(response => response.json())
        .then(data => {
            // Update the frontend with the product data
