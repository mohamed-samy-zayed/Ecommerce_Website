...
<html lang="en">
    ...
    <body>
        ...
        <div style="width: 50%; text-align: center; margin-left: 27%;">
            <h1 style="color: red;">من فضلك املئ جميع البيانات مثل<br>
            [الحجم , اللون , مكان الاستلام , عدد القطع المطلوبه , رقم التلفون الخاص بك للتواصل ]<br>
            قبل اتمام عملية الشراء</h1>
            <br>
            <br>
            <h1 style="color: red;">Please Fill All Product Info Fields : Size, Color, Location, Counter, Phone . Before Submitting </h1>
        </div>
        <!-- Shop End -->
        <!-- Footer Start -->
