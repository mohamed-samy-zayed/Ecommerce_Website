...
<html lang="en">
    <head>
        ...
        <!-- Favicon -->
        <link href="/g/favicon.ico" rel="icon">
        <!-- Google Web Fonts -->
    ...
    <body>
        ...
        <!-- Breadcrumb End -->
        <!-- Shop Start -->
        <div style="width: 50%; text-align: center; margin-left: 27%;">
            <h1 style="color: green;">تم تسجيل طلبك للتو وسوف يتم مراجعته ويتم التواصل معك علي رقم هاتفك لشحن المنتج اليك واستلامه في أقرب وقت ممكن </h1>
            <br>
            <br>
            <h1 style="color: green;">Your order has just been recorded. It will be reviewed, and we will contact you on your phone number to arrange the shipment of the product to you. You can expect to receive and collect it as soon as possible</h1>
        </div>
        <!-- Shop End -->
        <!-- Footer Start -->
