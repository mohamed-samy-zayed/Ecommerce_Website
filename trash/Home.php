                    ...
                    <div class="d-inline-flex align-items-center">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <button class="dropdown-item" type="button" onclick="reset()">Reset Password</button>
                                ...
                                <script>
                                    ...
                                    function reset() {
                                        // Redirect to the specified URL
                                        window.location.href = "http://localhost/all/project/ecommerce/changePassF.php";
                                    }
                                </script>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 d-none d-lg-block">
                    ...
                    <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                        <div class="navbar-nav w-100">
                            ...
                            <a href="shop.php" class="nav-item nav-link">Shirts</a>
                            <a href="shop.php" class="nav-item nav-link">Jackets</a>
            ...
            .then(data => {
                ...
                data.forEach(product => {
                    productContainer.innerHTML += `
                        <div class="col-lg-3 col-md-4 col-sm-6 pb-1" style="height: 400px; width: 150px;">
                            <div class="product-item bg-light mb-4">
                                <div class="product-img position-relative overflow-hidden">
                                    <img class="img-fluid w-100" src="${product.img_url}" alt="" style="height: 250px; width: 150px;">
                                    <div class="product-action">
                                        ...
                                        <a class="btn btn-outline-dark btn-square" href="detail.php">
